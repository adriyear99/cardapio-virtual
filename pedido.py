...
[ListButton@ToggleButton]
    ...
    Image:
        source: ctx.btn_img if ctx.text == ['Risoto','Picanha','Feijoada','Pizza'] \
...
<Test>
    Button:
        text: 'Pressione para escolher um pedido do menu'
        size_hint: .4, .4
...
<Cmenu>
    ...
    background_image: 'atlas://data/images/image-loading.gif/button_pressed'
...
class Cmenu(Bubble):
    ...
    def menu_selected(self, *l):
        ...
        elif l[0].text == 'Picanha':
            Animation(scroll_x=1, d=.5).start(l[0].parent.parent.parent)
        elif l[0].text == 'Feijoada':
            Animation(scroll_x=1, d=.5).start(l[0].parent.parent.parent)
        elif l[0].text == 'Pizza':
            Animation(scroll_x=1, d=.5).start(l[0].parent.parent.parent)
        else:
